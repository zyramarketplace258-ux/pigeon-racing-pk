...
interface GalleryPost { id: string; imageUrl: string; title: string; description: string; postedBy: string; createdAt: { seconds: number } | null }
              ...
              {[1, 2].map(i => (
                <div key={i} className="bg-white rounded-xl border border-[#d4edda] shadow-sm overflow-hidden animate-pulse">
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    <div className="h-2.5 bg-green-100 rounded w-4/5"></div>
                  </div>
                </div>
              ))}
            </div>
