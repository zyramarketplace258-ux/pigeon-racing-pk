...
<button onClick={toggle} className="text-xs text-green-300 border border-green-700 px-2.5 py-1 rounded hover:bg-green-800 active:scale-95 transition font-medium">
      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-4 py-4">
        ...
        <div className="bg-white rounded-xl border border-[#d4edda] shadow-sm overflow-hidden mb-4">
          <div className="bg-gradient-to-r from-[#1b5e20] to-[#388e3c] px-4 py-2">
            <p className="text-green-200 text-xs font-bold uppercase tracking-widest">Developer</p>
          </div>
          <div className="px-4 py-4 flex items-center gap-4">
            ...
            <a
              href="https://wa.me/923426003906"
              target="_blank"
              rel="noopener noreferrer"
              className="shrink-0 flex items-center gap-1.5 bg-[#25D366] text-white text-xs font-semibold px-3 py-2 rounded-lg shadow active:scale-95 transition"
            >
